"""Canonical field lists, name mappings, and training weights."""

# ======================== Field lists ========================

# Static surface fields used as context.
CONSTANTS = [
...
# Single-level meteorological fields.
SINGLE_LEVEL_VARS = [
...
# Pressure-level meteorological fields.
PRESSURE_LEVEL_VARS = [
    "geopotential",
    "u_component_of_wind",
    "v_component_of_wind",
...
# Full field plus level -> short field plus level.
NAME_LEVEL_TO_VAR_LEVEL = {}

# Build mappings for single-level fields.
for var in SINGLE_LEVEL_VARS:
    if var in NAME_TO_VAR:
        NAME_LEVEL_TO_VAR_LEVEL[var] = NAME_TO_VAR[var]

# Build mappings for pressure-level fields.
...
# Pressure-level weights normalized by pressure.
...
# Static fields are context only and do not contribute to loss.
static_weight_dict = {
    'geopotential_at_surface': 0.0,
    'land_sea_mask': 0.0,
}

# Combined field weights.
WEIGHT_DICT = {**single_level_weight_dict, **pressure_level_weight_dict, **static_weight_dict}
